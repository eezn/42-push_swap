...
/*   Updated: 2021/07/05 18:53:19 by jin-lee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static int	get_result(char **line, char **archive_fd, int idx)
{
	char			*cut_before;
	char			*cut_after;
...
static char	*attach_buf(char *archive_fd, char *buf)
{
	char			*ret;
